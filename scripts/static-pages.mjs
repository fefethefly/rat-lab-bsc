...
const pages={create:['Mission studio','Design eight targets. Submit a real neural experiment and share its saved result.'],live:['Live experiment','Watch RAT LAB neural inference, recorded sessions and replay verification.'],buyback:['Buyback ledger','Trace simulated BNB allocations from verified neural runs. Real purchases are disabled.'],challenge:['Aim Eight challenge','Try the same eight targets as R-01. Compare your local practice score to a recorded neural run.']};
